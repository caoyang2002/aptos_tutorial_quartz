...
_虽然已经过数年，但由于本文仍然可提供有用的参考并能够准确表述以太坊及其愿景，我们仍然在维护它。 若想了解以太坊的最新进展，以及以太坊协议的更新情况，我们推荐您阅读[本指南](https://ethereum.org/zh/learn/)。_

[寻求此白皮书早期版本或规范版本 [自 2014 年 12 月起] 的研究人员和学者应使用此 PDF。](https://ethereum.org/content/whitepaper/whitepaper-pdf/Ethereum_Whitepaper_-_Buterin_2014.pdf)

## [](https://ethereum.org/zh/whitepaper/#a-next-generation-smart-contract-and-decentralized-application-platform)下一代智能合约和去中心化应用平台
...
## [](https://ethereum.org/zh/whitepaper/#introduction-to-bitcoin-and-existing-concepts)比特币及现有概念简介

### [](https://ethereum.org/zh/whitepaper/#history)历史
...
### [](https://ethereum.org/zh/whitepaper/#bitcoin-as-a-state-transition-system)比特币是一个状态转换系统

[![以太坊状态转换](https://ethereum.org/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fethereum-state-transition.png&w=1920&q=75)](https://ethereum.org/content/whitepaper/ethereum-state-transition.png)
...
### [](https://ethereum.org/zh/whitepaper/#mining)挖矿

[![以太坊区块](https://ethereum.org/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fethereum-blocks.png&w=1920&q=75)](https://ethereum.org/content/whitepaper/ethereum-blocks.png)
...
### [](https://ethereum.org/zh/whitepaper/#merkle-trees)默克尔树

[![比特币简化支付确认](https://ethereum.org/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fspv-bitcoin.png&w=1920&q=75)](https://ethereum.org/content/whitepaper/spv-bitcoin.png)
...
### [](https://ethereum.org/zh/whitepaper/#alternative-blockchain-applications)其它的区块链应用
...
### [](https://ethereum.org/zh/whitepaper/#scripting)脚本
...
## [](https://ethereum.org/zh/whitepaper/#ethereum)以太坊
...
### [](https://ethereum.org/zh/whitepaper/#ethereum-accounts)以太坊帐户
...
### [](https://ethereum.org/zh/whitepaper/#messages-and-transactions)消息和交易
...
### [](https://ethereum.org/zh/whitepaper/#messages)消息
...
### [](https://ethereum.org/zh/whitepaper/#ethereum-state-transition-function)以太坊状态转换函数

[![以太币状态转换](https://ethereum.org/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fether-state-transition.png&w=1920&q=75)](https://ethereum.org/content/whitepaper/ether-state-transition.png)
...
### [](https://ethereum.org/zh/whitepaper/#code-execution)代码执行
...
### [](https://ethereum.org/zh/whitepaper/#blockchain-and-mining)区块链和挖矿

[![以太坊应用框图](https://ethereum.org/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fethereum-apply-block-diagram.png&w=1920&q=75)](https://ethereum.org/content/whitepaper/ethereum-apply-block-diagram.png)
...
## [](https://ethereum.org/zh/whitepaper/#applications)应用
...
### [](https://ethereum.org/zh/whitepaper/#token-systems)代币系统
...
### [](https://ethereum.org/zh/whitepaper/#financial-derivatives-and-stable-value-currencies)金融衍生品和价值稳定的货币
...
### [](https://ethereum.org/zh/whitepaper/#identity-and-reputation-systems)身份和信誉系统
...
### [](https://ethereum.org/zh/whitepaper/#decentralized-file-storage)去中心化文件存储
...
### [](https://ethereum.org/zh/whitepaper/#decentralized-autonomous-organizations)去中心化自治组织
...
### [](https://ethereum.org/zh/whitepaper/#further-applications)更多应用
...
## [](https://ethereum.org/zh/whitepaper/#miscellanea-and-concerns)杂项和关注

### [](https://ethereum.org/zh/whitepaper/#modified-ghost-implementation)改进版 GHOST 协议的实现
...
### [](https://ethereum.org/zh/whitepaper/#fees)费用
...
### [](https://ethereum.org/zh/whitepaper/#computation-and-turing-completeness)计算和图灵完备
...
### [](https://ethereum.org/zh/whitepaper/#currency-and-issuance)货币和发行
...
#### [](https://ethereum.org/zh/whitepaper/#%E9%95%BF%E6%9C%9F%E4%BE%9B%E5%BA%94%E5%A2%9E%E9%95%BF%E7%8E%87%EF%BC%88%E7%99%BE%E5%88%86%E6%AF%94%EF%BC%89)长期供应增长率（百分比）

[![以太坊通货膨胀](https://ethereum.org/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fethereum-inflation.png&w=1920&q=75)](https://ethereum.org/content/whitepaper/ethereum-inflation.png)
...
### [](https://ethereum.org/zh/whitepaper/#mining-centralization)挖矿中心化
...
### [](https://ethereum.org/zh/whitepaper/#scalability)可扩展性
...
## [](https://ethereum.org/zh/whitepaper/#conclusion)结论
...
## [](https://ethereum.org/zh/whitepaper/#notes-and-further-reading)注释与延伸阅读

### [](https://ethereum.org/zh/whitepaper/#notes)注释
...
### [](https://ethereum.org/zh/whitepaper/#further-reading)延伸阅读
...
_和众多社区驱动的开源软件项目一样，以太坊自启动以来一直不断发展。 若想了解以太坊的最新进展以及如何更改以太坊协议，我们推荐您阅读[本指南](https://ethereum.org/zh/learn/)。_